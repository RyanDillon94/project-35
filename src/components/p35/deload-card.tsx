  ...
  return (
    <div className="flex items-center justify-between w-full rounded-lg border border-border bg-surface-2/60 p-3.5 gap-2">
      ...
      <Button
        ...
        className="inline-flex items-center justify-center gap-1.5 px-3 h-8 text-xs font-semibold transition-colors rounded-md border shrink-0 border-border bg-transparent text-secondary-foreground hover:bg-secondary/80"
      >
